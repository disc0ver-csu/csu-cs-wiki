...
{
  private static String  _id = "IDL:VoteAppTest/Vote:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[1] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (VoteAppTest.VoteHelper.id (), "Vote", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    VoteAppTest.Vote value = new VoteAppTest.Vote ();
